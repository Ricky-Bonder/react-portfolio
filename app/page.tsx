        ...
        <main className="min-h-screen relative overflow-hidden">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="mt-16 space-y-12">
              <div>
                <p className="text-sm text-foreground/60 mb-4">Backend Technologies</p>
              ...
              <div>
                <p className="text-sm text-foreground/60 mb-4">Frontend Technologies</p>
                <div style={{ height: '100px', position: 'relative', overflow: 'hidden'}}>
                  <LogoLoop
                    logos={frontendTechs}
                    speed={50}
              ...
              <div>
                <p className="text-sm text-foreground/60 mb-4">Tools & DevOps</p>
                <div style={{ height: '100px', position: 'relative', overflow: 'hidden'}}>
                  <LogoLoop
                    logos={toolsTechs}
                    speed={50}
